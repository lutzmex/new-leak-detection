...
const TrustIndicator = memo(({ icon: Icon, text }: { icon: React.ElementType, text: string }) => (
  <div className="flex items-center gap-2">
    ...
    <span className="font-medium text-xs sm:text-sm text-slate-800">{text}</span>
  </div>
));
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="flex items-center gap-3 mb-6 lg:mb-8 opacity-100">
                <Image 
                ...
                <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-3 py-1.5 sm:py-2">
                  ...
                  <span className="font-medium text-green-700 text-xs sm:text-sm lg:text-base">America No. 1 Leak Detection Company</span>
                </div>
              </div>
              
              <h1 className="font-medium text-xl sm:text-2xl lg:text-3xl text-slate-900 leading-tight mb-4 sm:mb-6 lg:mb-8 opacity-100">
                Expert Leak Detection in America | Water, Gas & Pool Leak Specialists Nationwide
              </h1>
              
              <h2 className="font-medium text-base sm:text-lg lg:text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6 lg:mb-8 opacity-100">
                Full coverage across all American communities
              </h2>
              
              <p className="text-sm sm:text-base lg:text-lg text-slate-800 leading-relaxed mb-6 sm:mb-8 lg:mb-10 opacity-100">
              ...
              {/* CTA Button */}
              <div className="mb-6 lg:mb-8 opacity-100">
                <button 
                  onClick={handleCallClick}
                  className="inline-flex items-center bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 text-blue-800 hover:from-blue-200 hover:to-purple-200 px-4 sm:px-6 lg:px-10 py-3 sm:py-4 lg:py-5 rounded-2xl font-medium text-sm sm:text-base lg:text-xl transition-all transform hover:scale-105 shadow-lg gap-2 sm:gap-3 w-full sm:w-auto justify-center sm:justify-start"
                >
              ...
              {/* Trust Indicators */}
              <div className="flex flex-wrap items-center gap-3 sm:gap-6 lg:gap-8 text-slate-800 opacity-100">
            ...
            {/* Hero Image */}
            <div className="relative order-1 lg:order-2 opacity-100">
              <div className="relative w-full aspect-[4/3] sm:aspect-[3/2] lg:aspect-[4/3] xl:aspect-[3/2] rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-xs text-slate-800">Help Available Now</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="font-medium text-slate-800 mb-6 text-lg">Trusted by customers on these platforms</p>
