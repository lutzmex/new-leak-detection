    ...
    <article className="bg-white/90 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-slate-200 hover:border-slate-300 group">
      <Link href={`/blog/${post.slug}`} className="block h-full">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            {post.tags && post.tags.length > 0 && (
              <div className="flex items-center gap-1">
                ...
                <span className="font-poppins text-xs text-slate-500 truncate max-w-[100px]">
                  {post.tags[0]}
                </span>
              </div>
            )}
          ...
          <h3 className="font-poppins font-medium text-lg sm:text-xl text-slate-800 mb-3 line-clamp-2 leading-tight group-hover:text-slate-700 transition-colors">
            {post.title}
          </h3>

          {/* Excerpt */}
          {post.excerpt && (
            <p className="font-poppins text-sm text-slate-600 mb-4 line-clamp-2 leading-relaxed">
              {post.excerpt}
            </p>
          )}

          {/* Footer */}
          <div className="flex items-center justify-between font-poppins text-sm text-slate-500 pt-4 border-t border-slate-100">
  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-16">
      ...
      <button
        ...
        className={`flex items-center gap-1 px-3 sm:px-4 py-2 font-poppins font-medium text-sm rounded-lg transition-all ${
          currentPage === 1 
      ...
      <div className="flex items-center gap-1 sm:hidden">
        {mobilePages.map((page) => (
          <button
            ...
            className={`px-3 py-2 font-poppins font-medium text-sm rounded-lg transition-all min-w-[40px] ${
              currentPage === page
      ...
      <div className="flex items-center sm:hidden px-3 py-2 font-poppins text-xs text-slate-500 bg-slate-50 rounded-lg border border-slate-200">
      ...
      <section className="py-8 sm:py-12 lg:py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <div className={`inline-flex items-center bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 text-blue-800 px-6 py-3 rounded-full font-poppins font-medium text-sm mb-6 shadow-sm transform transition-all duration-1000 ${
            ...
            <h1 className={`font-poppins font-medium text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-slate-900 leading-tight mb-4 sm:mb-6 lg:mb-8 transform transition-all duration-1000 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            ...
            <p className={`font-poppins text-base sm:text-lg lg:text-xl text-slate-700 leading-relaxed mb-6 sm:mb-8 lg:mb-10 max-w-3xl mx-auto transform transition-all duration-1000 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            ...
            {/* Search Bar */}
            <div className={`max-w-2xl mx-auto mb-6 sm:mb-8 lg:mb-10 transform transition-all duration-1000 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                ...
                <div className="bg-white/90 backdrop-blur-sm border border-slate-200 rounded-2xl p-2 shadow-lg hover:shadow-xl transition-all">
                  <div className="flex items-center gap-3">
                    <div className="relative flex-1">
                      ...
                      <input
                        className="flex h-10 w-full rounded-md border-input px-3 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm pl-12 pr-4 py-3 font-poppins text-base border-0 bg-transparent focus:ring-0 focus:outline-none placeholder:text-slate-500"
            ...
            {/* Stats */}
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto transform transition-all duration-1000 ${
              isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`} style={{transitionDelay: '800ms'}}>
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-blue-200">
                <div className="font-poppins font-medium text-4xl text-blue-600 mb-1">{leakDetectionPosts.length}+</div>
                <div className="font-poppins text-slate-700 text-base">Expert Articles</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-blue-200">
                <div className="font-poppins font-medium text-4xl text-purple-600 mb-1">50K+</div>
                <div className="font-poppins text-slate-700 text-base">Monthly Readers</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-blue-200">
                <div className="font-poppins font-medium text-4xl text-green-600 mb-1">15+</div>
                <div className="font-poppins text-slate-700 text-base">Industry Experts</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-blue-200">
                <div className="font-poppins font-medium text-4xl text-orange-600 mb-1">99%</div>
                <div className="font-poppins text-slate-700 text-base">Satisfaction Rate</div>
              </div>
            </div>
          </div>
        </div>
          ...
          {currentPosts.length === 0 ? (
            <div className="text-center py-16">
              <div className="bg-white rounded-3xl p-8 max-w-md mx-auto shadow-sm border border-slate-200">
                ...
                <h3 className="font-poppins font-medium text-xl text-slate-800 mb-2">No Articles Found</h3>
                <p className="font-poppins text-slate-600 mb-6">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-poppins font-medium transition-all duration-300 shadow-sm"
                >
            ...
            <div className="bg-slate-50 rounded-3xl p-8 text-slate-700 shadow-sm relative overflow-hidden">
              <div className="relative z-10">
                <div className="inline-flex items-center bg-white/90 border border-slate-200 rounded-full px-6 py-3 mb-6">
                  ...
                  <span className="font-poppins font-medium">Expert Knowledge at Your Service</span>
                </div>
