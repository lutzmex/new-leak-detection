...
const CITIES_DYNAMIC_REGISTRY: { [state: string]: { [city: string]: CityDynamicData } } = {
  alabama: {
    'alexander-city': alexandercity_al_DynamicData,
  ...
  arkansas: {
    ...
    'van-buren': vanburen_ar_DynamicData,
  ...
  california: {
    ...
    'chula-vista': chulavista_ca_DynamicData,
  ...
  connecticut: {
    ...
    'windsor-locks': windsorlocks_ct_DynamicData,
  ...
  georgia: {
    ...
    'la-grange': lagrange_ga_DynamicData,
  ...
  indiana: {
    ...
    'new-castle': newcastle_in_DynamicData,
  ...
  kansas: {
    ...
    'council-grove': councilgrove_ks_DynamicData,
    'dodge-city': dodge_city_ks_DynamicData,
    'emporia': emporia_ks_DynamicData,
    'fort-scott': fortscott_ks_DynamicData,
    ...
    'smith-center': smithcenter_ks_DynamicData,
  ...
  michigan: {
    ...
    'bloomfield-hills': bloomfieldhills_mi_DynamicData,
    ...
    'traverse-city': traversecity_mi_DynamicData,
  ...
  minnesota: {
    ...
    'red-wing': redwing_mn_DynamicData,
  ...
  mississippi: {
    'bay-saint-louis': baysaintlouis_ms_DynamicData,
  ...
  missouri: {
    ...
    'cape-girardeau': capegirardeau_mo_DynamicData,
    ...
    'sainte-genevieve': saintegenevieve_mo_DynamicData,
  ...
  'new-mexico': {
    ...
    'silver-city': silvercity_nm_DynamicData,
  ...
  'new-york': {
    ...
    'east-aurora': eastaurora_ny_DynamicData,
  ...
  'north-carolina': {
    ...
    'rocky-mount': rockymount_nc_DynamicData,
  ...
  'north-dakota': {
    ...
    'valley-city': valleycity_nd_DynamicData,
  ...
  oregon: {
    ...
    'the-dalles': thedalles_or_DynamicData,
  ...
  wisconsin: {
    ...
    'fond-du-lac': fonddulac_wi_DynamicData,
    ...
    'new-glarus': newglarus_wi_DynamicData,
