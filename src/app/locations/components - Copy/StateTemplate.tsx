...
export default function StateTemplate({ stateData }: StateTemplateProps) {
  ...
  // Helper function to replace {stateName} placeholders
  ...
  // Content section specific heading classes
  ...
  const hasSimplifiedContent = (stateData.content as any).sections && 
  ...
  const displayedServices = showAllServices ? stateData.services.list : stateData.services.list.slice(0, servicesToShow);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8">
        <nav className="flex items-center gap-2 sm:gap-3 font-poppins text-sm sm:text-base lg:text-lg text-slate-600 mb-6 sm:mb-8" aria-label="Breadcrumb">
          ...
          <ChevronRight className="h-4 w-4 sm:h-5 sm:w-5 text-slate-400" />
          <span className="text-slate-800 font-medium truncate">{stateData.name}</span>
        </nav>
      </div>
            ...
            <div className="order-2 lg:order-1">
              <div className={`flex items-center gap-3 mb-6 lg:mb-8 transform transition-all duration-1000 ${
                ...
                <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-3 py-1.5 sm:py-2">
                  ...
                  <span className="text-green-700 font-poppins font-medium text-xs sm:text-base lg:text-xl">
              ...
              <div className={`mb-6 lg:mb-8 transform transition-all duration-1000 ${
                ...
                >
                  ...
                  {stateData.ui.heroSection.ctaButton.text} <span className="font-ibm-plex-mono font-medium">{stateData.contact.phoneDisplay}</span>
                </Link>
              </div>
              ...
              <div className="relative w-full aspect-[4/3] sm:aspect-[3/2] lg:aspect-[4/3] xl:aspect-[3/2] rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-poppins font-medium text-xs text-slate-800">
        ...
        <section className="py-8 sm:py-12 lg:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <p className="font-poppins text-slate-600 mb-6 text-lg font-medium">{stateData.trustPlatforms.title}</p>
          ...
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-6">
                <h3 className="font-poppins font-medium text-xl text-slate-800 mb-3">{stateData.ui.ctaSections.afterContent.title}</h3>
                <Link 
                  href={`tel:${stateData.contact.phone}`}
                ...
                >
                  ...
                  {stateData.ui.ctaSections.afterContent.buttonText} <span className="font-ibm-plex-mono font-medium">{stateData.contact.phoneDisplay}</span>
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 via-slate-50 to-purple-50 rounded-3xl p-8 lg:p-12 shadow-sm relative overflow-hidden max-w-4xl mx-auto">
              <div className="relative z-10 text-center">
                <div className="inline-flex items-center bg-white/90 border border-blue-200 rounded-full px-6 py-3 mb-6">
                  ...
                  <span className="font-poppins font-medium text-blue-800">{stateData.ui.ctaSections.afterServices.badge.text}</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    ...
                    {stateData.ui.ctaSections.afterServices.primaryButton.text} <span className="font-ibm-plex-mono font-medium">{stateData.contact.phoneDisplay}</span>
      ...
      {/* Why Choose Us Section - FIXED WITH PLACEHOLDER REPLACEMENTS */}
      <section className="py-8 sm:py-12 lg:py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-6 sm:mb-8 lg:mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 text-blue-800 px-6 py-3 rounded-full font-poppins font-medium text-sm shadow-sm mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {stateData.whyChooseUs.reasons.map((reason, index) => (
              <div key={index} className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-2 text-center border border-slate-200 hover:border-slate-300">
                ...
                <p className="font-poppins text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-6">
                <h3 className="font-poppins font-medium text-xl text-slate-800 mb-3">{stateData.ui.ctaSections.afterReviews.title}</h3>
                <Link 
                  href={`tel:${stateData.contact.phone}`}
                  className="inline-flex items-center bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 text-blue-800 hover:from-blue-200 hover:to-purple-200 px-6 py-3 rounded-xl font-poppins font-medium transition-all gap-2"
                >
                  <Phone className="h-4 w-4" />
                  {stateData.ui.ctaSections.afterReviews.buttonText} <span className="font-ibm-plex-mono font-medium">{stateData.contact.phoneDisplay}</span>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {stateData.process.steps.map((step, index) => (
              <div key={step.step} className="text-center bg-white/90 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-blue-200">
                ...
                <div className="text-blue-600 font-poppins font-medium mb-2 text-sm">{stateData.ui.processSection.stepLabel} {step.step}</div>
                <h3 className="font-poppins font-medium text-xl text-slate-800 mb-4">
      ...
      <section className="py-8 sm:py-12 lg:py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 sm:gap-6">
            {stateData.cities.slice(0, citiesToShow).map((city, index) => (
              <Link
                key={index}
          ...
          <div className="text-center mt-12">
            <button 
              onClick={() => setCitiesToShow(prev => prev === 16 ? stateData.cities.length : 16)}
            ...
            <div className="bg-gradient-to-br from-blue-50 via-slate-50 to-purple-50 rounded-3xl p-8 lg:p-12 shadow-sm relative overflow-hidden">
              <div className="relative z-10 text-center">
                <div className="inline-flex items-center bg-white/90 border border-blue-200 rounded-full px-6 py-3 mb-6">
                  ...
                  <span className="font-poppins font-medium text-blue-800">
                ...
                <div className="flex justify-center mb-6">
                  ...
                  >
                    <Phone className="h-5 w-5" />
                    {replacePlaceholders(stateData.ui.ctaSections.beforeMap.buttonText)}
                    <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-slate-600">
                  {stateData.ui.ctaSections.beforeMap.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <span className="font-poppins">{replacePlaceholders(feature.text)}</span>
                    </div>
                  ))}
                </div>
              </div>
